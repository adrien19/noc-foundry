...
- `main` publishes to `https://docs.nocfoundry.com/dev/`
- release tags publish to `https://docs.nocfoundry.com/vX.Y.Z/`
- the newest release is mirrored to `https://docs.nocfoundry.com/latest/`
