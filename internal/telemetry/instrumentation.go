...
const (
	TracerName = "github.com/adrien19/noc-foundry/internal/opentel"
	MetricName = "github.com/adrien19/noc-foundry/internal/opentel"
	...
	mcpActiveSessionsName     = "nocfoundry.server.mcp.active_sessions"
	toolExecutionDurationName = "nocfoundry.tool.execution.duration"
)

// Instrumentation defines the telemetry instrumentation for nocfoundry
