...
func SetupOTel(ctx context.Context, versionString, telemetryOTLP, telemetryServiceName string) (shutdown func(context.Context) error, err error) {
	...
	tracerProvider, err := newTracerProvider(ctx, res, telemetryOTLP)
	if err != nil {
	...
	meterProvider, err := newMeterProvider(ctx, res, telemetryOTLP)
	if err != nil {
...
func newTracerProvider(ctx context.Context, r *resource.Resource, telemetryOTLP string) (*tracesdk.TracerProvider, error) {
...
func newMeterProvider(ctx context.Context, r *resource.Resource, telemetryOTLP string) (*metric.MeterProvider, error) {
