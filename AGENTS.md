...
This file (symlinked as `CLAUDE.md` and `AGENTS.md`) provides context and guidelines for AI agents working on the NOCFoundry project. It summarizes key information from `CONTRIBUTING.md` and `DEVELOPER.md`.
